...
class CurrAdapter(private var currViewModel: CurrViewModel) :
    ...
    private fun configureItemView(viewHolder: CurrItemHolder, position: Int) {
            val conversionText: String = currViewModel.getExchangeRateText(position)
            viewHolder.titleTv.text = conversionText
    }

    override fun getItemCount(): Int {
        return currViewModel.currMap?.size ?: 0
    }
